...
import ExamPreparation_1.hell.entities.miscellaneous.HeroInventory;
import ExamPreparation_1.hell.entities.miscellaneous.ItemCollection;
import ExamPreparation_1.hell.interfaces.Hero;
import ExamPreparation_1.hell.interfaces.Inventory;
...
abstract class Heroes implements Hero {
    ...
    public String toString() {
        String itemsString = this.getItems().isEmpty()
                ? "None"
                : "\n";
