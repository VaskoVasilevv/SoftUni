...
public class BookServiceImpl implements BookService {
    ...
    public void seedBooks() throws IOException {
        ...
        Files
                .readAllLines(Path.of("D:\\SoftUniGit\\src\\SpringData\\AdvancedQueringExercise\\src\\main\\resources\\files\\books.txt"))
                .forEach(row -> {
    ...
    @Override
    public List<String> findAllBookTitleWithCopiesLessThen5000() {

        return bookRepository.findAllByCopiesLessThanAndEditionType(5000, EditionType.GOLD)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<String> findAllBooksTitlesThatNotReleasedInTheYear(int year) {
    ...
    @Override
    public List<String> findAllBooksThatContainsGivenString(String input) {
    ...
    @Override
    public List<String> findAllBooksThatAuthorNameStartsWith(String input) {
    ...
    @Override
    public int findAllBooksTitleLength(int input) {
        return bookRepository.countOfBooksWithTitleLengthMoreThen(input);
    }

    @Override
    public String findAllInformation(String input) {

        Book book = bookRepository.findBookByTitle(input);
