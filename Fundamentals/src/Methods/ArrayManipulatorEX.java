...
public class ArrayManipulatorEX {
    ...
    public static void printLastEvenNumbersCount(int[] arr, int count) {
    ...
    public static int findMaxEvenElementIndex(int[] arr) {
    ...
    public static int findMaxOddElementIndex(int[] arr) {
        int maxElement = Integer.MIN_VALUE;
        int index = -1;
        for (int i = 0; i < arr.length; i++) {
            if (arr[i] % 2 != 0 && arr[i] >= maxElement) {
    ...
    public static void exchangeArray(int[] arr, int index) {
    ...
    public static int findMinEvenElementIndex(int[] arr) {
    ...
    public static int findMinOddElementIndex(int[] arr) {
        int minElement = Integer.MAX_VALUE;
        int index = -1;
        for (int i = 0; i < arr.length; i++) {
            if (arr[i] % 2 != 0 && arr[i] <= minElement) {
