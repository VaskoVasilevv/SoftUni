...
public class Homework {
    ...
    private static void exThree() throws IOException, SQLException {
        ...
        PreparedStatement preparedStatement = con.prepareStatement("SELECT v.name,m.`name`,m.age FROM minions as m\n" +
    ...
    private static void addMinion(String minionName, int minionAge, int townId) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO minions (name, age, town_id) VALUES (?,?,?)");
    ...
    private static void addMinionToVillain(int minionId1, int villainId1) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("UPDATE minions_villains\n" +
    ...
    private static int findVillainIdByName(String villainName) throws SQLException {
        ...
        PreparedStatement preparedStatement= con.prepareStatement("SELECT id FROM villains WHERE name = ?");
    ...
    private static int findMinionByName(String minionName) throws SQLException {
        ...
        PreparedStatement preparedStatement = con.prepareStatement("SELECT id FROM minions WHERE name = ?");
        preparedStatement.setString(1,minionName);
        ResultSet resultSet = preparedStatement.executeQuery();
    ...
    private static void addTown(String minionTown) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO towns(name) VALUES (?)");
    ...
    private static int findTownIdByName(String minionTown) throws SQLException {
        ...
        PreparedStatement preparedStatement = con.prepareStatement("SELECT id FROM towns WHERE name = ?");
    ...
    private static void addVillain(String villainName) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO villains(name)" +
                "VALUES (?)");
        preparedStatement.setString(1,villainName);
        preparedStatement.executeUpdate();
    }
    ...
    private static String findVillainByName(String villainName) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("SELECT name FROM villains WHERE name = ?");
        preparedStatement.setString(1,villainName);
        ResultSet resultSet = preparedStatement.executeQuery();
    ...
    private static void exFive() throws IOException, SQLException {
        ...
        PreparedStatement preparedStatement =
                con.prepareStatement("UPDATE towns SET name = UPPER(name) WHERE country = ?");
        ...
        PreparedStatement preparedStatementTowns =
                con.prepareStatement("SELECT name FROM towns WHERE country = ?");
    ...
    private static void deleteEntityById(int villainId) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("DELETE from villains where id = ?");
    ...
    private static int deleteMinionsByVillainId(int id) throws SQLException {
        ...
        PreparedStatement preparedStatement = con.prepareStatement("DELETE FROM minions_villains WHERE villain_id = ?");
    ...
    private static void exSeven() throws SQLException {
        ...
        PreparedStatement preparedStatement =
                con.prepareStatement("SELECT name FROM minions");
    ...
    private static void exEight() throws IOException, SQLException {
        ...
        PreparedStatement preparedStatement =
                con.prepareStatement("UPDATE minions as m\n" +
        ...
        PreparedStatement preparedStatementAll = con.prepareStatement("SELECT name,age FROM minions;");
